...
#define CUSTOM_MACHINE_NAME "Tarantulo"
...
#define PSU_NAME "Poper Supply"
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_E_TEMP         130 // (°C) Turn on PSU if any extruder is over this temperature
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 257.74
  #define DEFAULT_bedKi 50.65
  #define DEFAULT_bedKd 327.88
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.30, 80.20, 1650, 104 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, -13, -0.88 }
